...
>
> **⚠️ ВНИМАНИЕ: ВАШИ МЫСЛИ, ЦЕЛИ И ЗАПИСИ БУДУТ ВИДНЫ ВСЕМ В ИНТЕРНЕТЕ!**
>
> По умолчанию форк — публичный. Это значит, что **любой человек** может прочитать ваши личные записи, цели и мысли. **Сделайте репозиторий приватным СРАЗУ после форка!**
>
> ---
>
> ### 📋 Шаги через веб-интерфейс GitHub:
>
> 1. Перейдите в **Settings** (Настройки) вашего форка
> 2. Прокрутите вниз до раздела **"Danger Zone"** (красная зона)
> 3. Нажмите **"Leave fork network"** (Выйти из fork-сети) и подтвердите
> 4. **Обновите страницу** (F5)
> 5. Вернитесь в **"Danger Zone"**
> 6. Нажмите **"Change visibility"** → выберите **"Private"** (Приватный)
> 7. Подтвердите действие
>
> ---
>
> ✅ **После этого:** только вы сможете видеть содержимое репозитория.
>
> ❌ **Если не сделать:** ваши голосовые расшифровки, личные цели, мысли и идеи будут доступны в Google и любому желающему.
